...
- **Cible ambitieuse** : la trajectoire produit un objectif de **0,78** en accuracy, utilisé pour le suivi des livrables WBS.
...
- **Sorties** :
  - CSV : lignes typées (`run`, `subject`, `global`) contenant l'accuracy et les drapeaux `meets_minimum` (≥0,75) et `meets_target` (≥0,75).
