...
| --- | --- | --- |
| Visualisation raw vs filtré ("Watch it for the plot") | 3.3.1–3.3.4 (visualisation filtrage) | `poetry run python scripts/visualize_raw_filtered.py data/raw/S01` ; `poetry run pytest tests/test_preprocessing.py::test_apply_bandpass_filter_preserves_shape_and_stability` |
