...
def x_run_synthetic_benchmark__mutmut_orig(n_samples: int = 120, sfreq: float = 128.0) -> pd.DataFrame:
...
def x_run_synthetic_benchmark__mutmut_1(n_samples: int = 121, sfreq: float = 128.0) -> pd.DataFrame:
    """Construit un benchmark synthétique pour comparer features et classifieurs."""
...
def x_run_synthetic_benchmark__mutmut_2(n_samples: int = 120, sfreq: float = 129.0) -> pd.DataFrame:
    """Construit un benchmark synthétique pour comparer features et classifieurs."""
...
x_run_synthetic_benchmark__mutmut_mutants : ClassVar[MutantDict] = {
'x_run_synthetic_benchmark__mutmut_1': x_run_synthetic_benchmark__mutmut_1, 
    'x_run_synthetic_benchmark__mutmut_2': x_run_synthetic_benchmark__mutmut_2
}

def run_synthetic_benchmark(*args, **kwargs):
    result = _mutmut_trampoline(x_run_synthetic_benchmark__mutmut_orig, x_run_synthetic_benchmark__mutmut_mutants, args, kwargs)
    return result 

run_synthetic_benchmark.__signature__ = _mutmut_signature(x_run_synthetic_benchmark__mutmut_orig)
x_run_synthetic_benchmark__mutmut_orig.__name__ = 'x_run_synthetic_benchmark'
