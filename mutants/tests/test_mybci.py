...
def test_build_parser_defines_realtime_defaults_and_help():
    ...
    # Récupère l'action raw-dir pour verrouiller l'option EDF brute
    raw_dir_action = get_action("raw_dir")
    ...
    # Vérifie que raw-dir conserve le défaut attendu
    assert raw_dir_action.default == "data"
    # Vérifie que l'aide raw-dir reste inchangée
